def add_time(start, duration, day=None):
    ...
    if day == None:
        if total_day == 0:
            print(time_stamp)
        if total_day == 1:
            print(time_stamp) + ' (next day)'
        print(time_stamp + ' (' + str(total_day) + ' days later)')
    else:
        ...
        for i, j in day_map.items():
            if j == ans_day:
                ...
                break
        if total_day == 0:
            print(time_stamp) + ', ' + ans_day
        if total_day == 1:
            print(time_stamp) + ', ' + ans_day + ' (next day)'
        print(time_stamp) + ', ' + ans_day + ' (' + str(
